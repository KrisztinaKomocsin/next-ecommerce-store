...
export const productsDatabase = [
...

  {
    ...
    name: 'Slowmoose',
    description:
      'Slowmoose x Hello Kitty beautiful luggage and travel case set. Material: ABS Item Weight: 3.4kg Item Height: 28cm Luggage Type: Carry-On Have Drawbar: Yes Item Width: 47cm Wheels: Spinner With Lock: Yes Item Length: 75cm',
    price: '549',
  },
...

  {
    ...
    name: 'Puma',
    description:
      'PUMA x Hello Kitty Large Shopper: Black. The Puma x Hello Kitty Large Shopper features Hello Kitty logo branding throughout the large shopping bag. The piece features two large handles and plenty of space. Material: nylon, polyurethane. Lining: polyester',
    price: '69',
  },
];
